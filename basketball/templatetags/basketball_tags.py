...
@register.inclusion_tag('player_5on5_possessions.html')
def player_five_on_five_pos(game_type="5on5",player_pk=None):
	return lb_five_on_five_pos(game_type=game_type,player_pk=player_pk)

@register.inclusion_tag('lb_5on5_possessions.html')
def lb_five_on_five_pos(game_type="5v5",player_pk=None):
	...
	dreb = helpers.per100_top_stat_players(game_type,'dreb',player_pk,excluded_pks)
	oreb = helpers.per100_top_stat_players(game_type,'oreb',player_pk,excluded_pks)  
	total_rebounds = helpers.per100_top_stat_players(game_type,'total_rebounds',player_pk,excluded_pks)
	asts = helpers.per100_top_stat_players(game_type,'asts',player_pk,excluded_pks)
	pot_ast = helpers.per100_top_stat_players(game_type,'pot_ast',player_pk,excluded_pks)
	stls = helpers.per100_top_stat_players(game_type,'stls',player_pk,excluded_pks)
	to = helpers.per100_top_stat_players(game_type,'to',player_pk,excluded_pks)
	points = helpers.per100_top_stat_players(game_type,'points',player_pk,excluded_pks)
	blk = helpers.per100_top_stat_players(game_type,'blk',player_pk,excluded_pks)
...
def lb_5on5_totals(player_pk=None):

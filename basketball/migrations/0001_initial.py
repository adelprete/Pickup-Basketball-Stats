    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(to='basketball.Game')),
        ...
        migrations.AddField(
            ...
            name='assist_player',
            field=models.ForeignKey(related_name='+', to='basketball.Player'),
        ),
        migrations.AddField(
            model_name='playbyplay',
            name='game',
            field=models.ForeignKey(to='basketball.Game'),
        ),
        migrations.AddField(
            model_name='playbyplay',
            name='primary_player',
            field=models.ForeignKey(related_name='primary_plays', to='basketball.Player'),
        ),
        migrations.AddField(
            model_name='playbyplay',
            name='secondary_player',
            field=models.ForeignKey(related_name='secondary_plays', to='basketball.Player'),
        ),
        migrations.AddField(
            model_name='game',
            name='team1',
